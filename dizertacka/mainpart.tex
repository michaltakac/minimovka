...
% toto zaclenit hore do odseku
to communicate insights to other scientists, professionals or general public. 

% prepisat (\citep{kressSituVisualizationTechniques})
...
% Info o pouzivani pointers a references v Ruste vs C++ --> useful pre ukazku ako sa pouzivaju pointers vo FFI s C# pre pracu s Unity
...
\begin{figure}[!ht]
	\centering
	\subfloat[Zoom interaction with hand controllers.\label{fig:zoom-interaction-hand-controllers}]{%
		\includegraphics[width=0.45\textwidth]{figures/empty.jpg}%
	}\qquad
	\subfloat[Zoom interaction with virtual hands.\label{fig:zoom-interaction-hands}]{%
		\includegraphics[width=0.45\textwidth]{figures/empty.jpg}%
	}
	\captionsetup{justification=centering}
	\caption{Variations of zoom interaction.}
	\label{fig:zoom-interaction}
\end{figure}
...
\begin{figure}[!ht]
	...
	\subfloat[Performance on Radeon R9 M370X GPU.\label{fig:d3q27_lid_mlups_r9_32bit}]{%
		\includegraphics[width=0.32\textwidth]{data/r9_32bit_d3q27_mrt_lid_mlups.pdf}%
	}\qquad
	\subfloat[Performance on GTX 1070 GPU.\label{fig:d3q27_lid_mlups_gtx1070_32bit}]{%
		\includegraphics[width=0.32\textwidth]{data/gtx1070_32bit_d3q27_mrt_lid_mlups.pdf}%
	}\qquad
	\subfloat[Performance on RTX 2080 Ti GPU.\label{fig:d3q27_lid_mlups_rtx2080ti_32bit}]{%
		\includegraphics[width=0.32\textwidth]{data/rtx2080ti_32bit_d3q27_mrt_lid_mlups.pdf}%
	}\qquad
	\subfloat[Performance on RTX 3090 GPU.\label{fig:d3q27_lid_mlups_rtx3090_32bit}]{%
		\includegraphics[width=0.32\textwidth]{data/rtx3090_32bit_d3q27_mrt_lid_mlups.pdf}%
	}
	\captionsetup{justification=centering}
...
\begin{figure}[!ht]
	...
	\subfloat[Performance on Radeon R9 M370X GPU.\label{fig:d3q27_lid_mlups_r9_64bit}]{%
		\includegraphics[width=0.32\textwidth]{data/r9_64bit_d3q27_mrt_lid_mlups.pdf}%
	}\qquad
	\subfloat[Performance on GTX 1070 GPU.\label{fig:d3q27_lid_mlups_gtx1070_64bit}]{%
		\includegraphics[width=0.32\textwidth]{data/gtx1070_64bit_d3q27_mrt_lid_mlups.pdf}%
	}\qquad
	\subfloat[Performance on RTX 2080 Ti GPU.\label{fig:d3q27_lid_mlups_rtx2080ti_64bit}]{%
		\includegraphics[width=0.32\textwidth]{data/rtx2080ti_64bit_d3q27_mrt_lid_mlups.pdf}%
	}\qquad
	\subfloat[Performance on RTX 3090 GPU.\label{fig:d3q27_lid_mlups_rtx3090_64bit}]{%
		\includegraphics[width=0.32\textwidth]{data/rtx3090_64bit_d3q27_mrt_lid_mlups.pdf}%
	}
	\captionsetup{justification=centering}
