...
The issue with efficiently sending the simulation data over wireless network manifests itself when the support for augmented reality devices comes into question.
