...
pdfkeywords={Process control, Steelmaking, Mathematical modeling, Visualization, Virtual Reality},
pdftitle={Design and implementation of modern methods for modeling and control of technological objects and processes},
...
\author{Ing.~Michal Takáč}
\title{Design and implementation of modern methods for modeling and control of technological objects and processes}
\subtitle{}
\abstrakte{
%This dissertation thesis deals with design and implementation of modern methods in process control focused on steelmaking, specifically basic oxygen process (LD/BOF)... dopisat
}
\keywords{Process control, Steelmaking, Visualization, Virtual Reality, Mathematical modeling}
\degree{PhD.}
...
\includepdf[pages=-]{prednastranask.pdf}
